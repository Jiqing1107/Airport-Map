...
1. Visualize the airports (represented by circles, the color of which indicate the altitude of the airport) and the routines (represented by lines).

2. When a user clicks an airport on the map, the color marker of the airport will change to blue and the size will become biger. The markers of other airports will disappear unless the airports have connection with the clicked airport on the route. Most of the routines will disappear as well. Only the rountines of the clicked airport are visible. 
